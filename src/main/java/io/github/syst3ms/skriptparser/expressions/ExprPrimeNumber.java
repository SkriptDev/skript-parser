...
//	}
//
//	private Expression<Integer> ordinal;
//
//	@SuppressWarnings("unchecked")
//	@Override
//	public boolean init(Expression<?>[] expressions, int matchedPattern, ParseContext parseContext) {
//		ordinal = (Expression<Integer>) expressions[0];
//		return true;
//	}
//
//	@Override
...
//				.filter(n -> n.compareTo(0) > 0)
//				.map(n -> {
//					if (NumberMath.getCachedPrimes().size() >= n.intValue()) {
//						return new Number[] {
//								Integer.valueOf(NumberMath.getCachedPrimes().get(n.intValue() - 1))
//						};
//					}
//					int candidate, count;
//					for (candidate = 2, count = 0; count < n.intValue(); candidate++) {
//						if (Math.prime(candidate))
//							count++;
//					}
//					return new Number[] {Integer.valueOf(candidate - 1)};
//				})
//				.orElse(new Number[0]);
//
//	}

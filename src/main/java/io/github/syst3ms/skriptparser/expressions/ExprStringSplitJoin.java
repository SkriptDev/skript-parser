...
public class ExprStringSplitJoin implements Expression<String> {
    static {
        Parser.getMainRegistration().newExpression(ExprStringSplitJoin.class, String.class, false,
            ...
            .name("Join/Split")
            .description("Joins multiple strings together using a delimiter, splits a given string using a delimiter, or splits that string in multiple string of a certain length.")
            .since("1.0.0")
            .register();
    }
